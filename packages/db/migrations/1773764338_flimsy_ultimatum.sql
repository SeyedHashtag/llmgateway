...
CREATE INDEX IF NOT EXISTS "model_provider_mapping_history_provider_id_model_id_minute_timestamp_idx" ON "model_provider_mapping_history" ("provider_id","model_id","minute_timestamp");--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "project_hourly_model_stats_used_provider_used_model_hour_timestamp_idx" ON "project_hourly_model_stats" ("used_provider","used_model","hour_timestamp");
